...
- Append ledger rows at the **bottom**; `EMPTY` must be the last row.
- On halt: run `npx omakaseagent status --gates` and hand the human ledger summary + pending gate paths.
