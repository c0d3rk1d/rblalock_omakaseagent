...
- Execute exactly **one iteration per run**: one queue item through the full factory loop, one gate file, one ledger row.
- The charter is the standing confirm. No synchronous user questions mid-iteration — where you would ask, **halt and record why** in the ledger.
